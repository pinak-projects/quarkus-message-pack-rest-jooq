...
public class UserServiceImpl implements UserService {
    ...
    public int createUser(User user) {
        UserMasterRecord userMasterRecord = dslContext.newRecord(USER_MASTER, user);
        userMasterRecord.setRoleId(user.getRole().getRoleId());
        System.out.println(userMasterRecord);
