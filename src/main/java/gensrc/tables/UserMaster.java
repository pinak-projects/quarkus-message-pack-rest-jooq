...
public class UserMaster extends TableImpl<UserMasterRecord> {
    ...
    private static final long serialVersionUID = -1879458024;
    ...
    public List<UniqueKey<UserMasterRecord>> getKeys() {
        return Arrays.<UniqueKey<UserMasterRecord>>asList(Keys.CONSTRAINT_8);
    }

    @Override
    public List<ForeignKey<UserMasterRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserMasterRecord, ?>>asList(Keys.CONSTRAINT_8E);
    }

    public RoleMaster roleMaster() {
        return new RoleMaster(this, Keys.CONSTRAINT_8E);
    }
